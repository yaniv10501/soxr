...
extern "C" {
    ...
    void* CreateSoxr(double inRate, double outRate, int channels) {
        soxr_error_t error;
    ...
    int ProcessSoxr(void* resampler, float* input, int inLen, float* output, int outLen) {
    ...
    void DestroySoxr(void* resampler) {
